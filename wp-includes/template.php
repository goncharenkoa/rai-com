 ...
 *
 * Looks for 'front-simple-page.php'. The template path is filterable via the
...
function get_front_page_template() {
	$templates = array('front-simple-page.php');
